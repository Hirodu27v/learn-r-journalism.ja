...
特定のファイルを除いてGitHubへのアップロードからするには、Use [.gitignore](https://git-scm.com/docs/gitignore) to exclude certain files from being uploaded to GitHub. Such as:
