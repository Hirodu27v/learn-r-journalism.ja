...
システムを準備するのに手間がかかります。 **sp** と **sf** の最大の違いはCRS情報の格納方法です。
**sp** は特別なuses spatial sub classes, **sf** stores data in data frames, allowing it to interact with **dplyr** methods we've learned so far. 
I encourage you to check out other spatial data analysis and modeling [classes](http://www.rspatial.org/) if you remain interested in this afterward.
{{% /notice %}}
